# Scala + Heroku Example, Dreamforce 2012

This is a simple Scala/SBT skeleton app that runs on Heroku.

The idea is to have a minimum of code and just show you how to set
up an SBT build for Heroku. HTTP is handled with Netty, but in
real life you probably want to use something higher-level such as
Play Framework.
